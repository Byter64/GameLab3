...
namespace Engine
{
    UITransform::UITransform(glm::vec3 position, glm::vec3 scale, glm::quat rotation) : translation(position), scale(scale), rotation(rotation)
    {
        parent = nullptr;
    }

    glm::vec3 UITransform::GetTranslation()
    {
        return translation;
    }

    void UITransform::SetTranslation(const glm::vec3 &translation)
    {
    ...
    void UITransform::AddTranslation(const glm::vec3 &translation)
    {
        this->translation += translation;
        hasTransformChanged = true;
    ...
    glm::vec3 UITransform::GetScale()
    {
        return scale;
    }

    void UITransform::SetScale(const glm::vec3 &scale)
    {
        this->scale = scale;
        hasTransformChanged = true;
    ...
    void UITransform::AddScale(const glm::vec3 &scale)
    {
        this->scale += scale;
        hasTransformChanged = true;
    ...
    glm::quat UITransform::GetRotation()
    {
        return rotation;
    }

    void UITransform::SetRotation(const glm::quat &rotation)
    {
    ...
    const glm::mat4x4 &UITransform::GetMatrix()
    {
    ...
    std::list<UITransform*> &UITransform::GetChildren()
    {
        return children;
    }

    std::string UITransform::MatrixToString()
    {
    ...
    glm::vec3 UITransform::GetGlobalTranslation()
    {
    ...
    glm::vec3 UITransform::GetGlobalScale()
    {
    ...
    glm::quat UITransform::GetGlobalRotation()
    {
    ...
    const glm::mat4x4 &UITransform::GetGlobalMatrix()
    {
    ...
    void UITransform::SetIsGlobalTranslationOutdated()
    {
    ...
    void UITransform::SetIsGlobalScaleOutdated()
    {
    ...
    void UITransform::SetIsGlobalRotationOutdated()
    {
    ...
    std::string UITransform::ToString()
    {
    ...
    std::string UITransform::GlobalTranslationToString()
    {
        glm::vec3 pos = GetGlobalTranslation();
        return "(" + std::to_string(pos.x) + ", " + std::to_string(pos.y) + ", " + std::to_string(pos.z) + ")";
    }

    UITransform &UITransform::operator=(UITransform &&other)
    {
